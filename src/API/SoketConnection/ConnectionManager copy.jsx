...
//       try {
//         if (data?.tvar) {
//           console.log("[SOCKET] ReceiveSignal:", data);
//           comboRebind(data.tvar, data.tparam);
//         }
//       } catch (err) {
//         console.error("[SOCKET] ReceiveSignal error:", err);
//       }
//     });
...
//   useEffect(() => {
//     if (!deviceStatus?.type) return;
//     if (!socketReady) return;
//     if (lastSignalRef.current === deviceStatus.type) return;
//     console.log(
//       "[DEVICE STATUS CHANGED]",
//       deviceStatus
//     );
//     lastSignalRef.current = deviceStatus.type;
//     handleBtnClick(deviceStatus.type);
//   }, [deviceStatus, socketReady]);


//   const handleBtnClick = (signal) => {
//     const socket = socketRef.current;
//     if (!socket) {
//       console.error("[SOCKET] Socket ref not found");
//       return;
//     }
...
//     console.log("[SOCKET] SendSignal emitted:", signal);
//   };

//   const comboRebind = (_tvar, _tparam) => {
//     const signal = _tvar?.toLowerCase()?.trim();
//     console.log("[SOCKET] comboRebind:", signal, _tparam);
//     switch (signal) {
//       case "reacttest":
...
//       default:
//         console.warn("[SOCKET] Unhandled signal:", signal);
//         break;
//     }
//   };
